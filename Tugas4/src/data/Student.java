...
public class Student extends User implements iMenu {
    ...
    public void choiceBook(Book[] bookList) {
        ...
        System.out.println("================================================================================================================");
        System.out.printf("|| %-4s || %-8s || %-20s || %-15s || %-15s || %-6s ||%n","No.", "Id Buku", "Nama Buku", "Author", "Category", "Stock");
        System.out.println("================================================================================================================");
        
        int index = 1;
        for (Book book : bookList) {
            if (book != null) {
                System.out.printf("|| %-4d || %-8s || %-20s || %-15s || %-15s || %-6d ||%n",index, book.getIdBuku(), book.getJudul(), book.getAuthor(), book.getCategory(), book.getStok());
                index++;
            }
        }
